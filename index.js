  ...
  try {
    ...
    const message = await anthropic.messages.create({
      ...
      messages: [{
        ...
        content: [{
          type: 'text',
          text: 'Tu es un coach sportif specialise en musculation. Voici le profil de la personne: ' + profileText + '. Voici ce qu\'elle veut atteindre: "' + goal_description + '". Construis un programme de musculation personnalise et realiste. Tiens compte des blessures signalees en adaptant/evitant les exercices a risque pour cette zone. Pour chaque exercice, indique une categorie musculaire parmi exactement: poitrine, dos, jambes, epaules, bras, abdos, cardio. Ajoute aussi 2 a 3 conseils d\'execution courts et concrets par exercice (position de depart, erreur frequente a eviter, point de controle). Reponds UNIQUEMENT avec un objet JSON valide, sans texte autour ni balises markdown, avec exactement cette structure: {"program_name":"nom court du programme","duration_weeks":8,"sessions_per_week":3,"weekly_schedule":[{"day":"Jour 1","focus":"ex: Haut du corps","exercises":[{"name":"nom exercice","category":"poitrine","sets":4,"reps":"8-10","rest_seconds":90,"notes":"conseil bref","execution_tips":["conseil 1","conseil 2","conseil 3"]}]}],"general_advice":"2-3 phrases de conseils generaux adaptes au profil et a l\'objectif"}'
        }]
      }]
    });
