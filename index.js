  ...
  try {
    ...
    const message = await anthropic.messages.create({
      ...
      messages: [{
        ...
        content: [{
          type: 'text',
          text: 'Tu es un coach sportif specialise en musculation. Voici le profil de la personne: ' + profileText + '. Voici ce qu\'elle veut atteindre: "' + goal_description + '". Construis un programme de musculation personnalise et realiste. Tiens compte des blessures signalees en adaptant/evitant les exercices a risque pour cette zone. Reponds UNIQUEMENT avec un objet JSON valide, sans texte autour ni balises markdown, avec exactement cette structure: {"program_name":"nom court du programme","duration_weeks":8,"sessions_per_week":3,"weekly_schedule":[{"day":"Jour 1","focus":"ex: Haut du corps","exercises":[{"name":"nom exercice","sets":4,"reps":"8-10","notes":"conseil bref"}]}],"general_advice":"2-3 phrases de conseils generaux adaptes au profil et a l\'objectif"}'
        }]
      }]
    });
